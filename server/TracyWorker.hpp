...
private:
    ...
    int64_t TscTime( int64_t tsc ) { return int64_t( ( tsc - m_data.baseTime ) ); }
    int64_t TscTime( uint64_t tsc ) { return int64_t( ( tsc - m_data.baseTime ) ); }
    int64_t TscPeriod( uint64_t tsc ) { return int64_t( tsc ); }
