...
#define LockMarkNamed( varname, lockname ) static constexpr tracy::SourceLocationData __tracy_lock_location_##__LINE__ { nullptr, TracyFunction,  TracyFile, (uint32_t)TracyLine, 0 }; lockname.Mark( &__tracy_lock_location_##__LINE__ )
